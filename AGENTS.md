...
- **Taken/roadmap:** Notion-database `db} DJ — L2TP roadmap` — Type **Website** voor sitewerk, Type **Nieuwsbrief** voor edities. Oude naam `db} DJ — Late 2 The Party` niet meer gebruiken.
...
# Vormgeving
- Font: Space Grotesk 400/600/700 **lokaal** in `docs/fonts/` (geen Google Fonts)
